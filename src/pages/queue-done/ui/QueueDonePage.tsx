    ...
    return (
      <section className="mx-auto max-w-3xl px-4 py-12">
        <Card className="p-8 text-center">
          <h1 className="text-3xl font-black text-slate-950">접수 정보를 찾을 수 없습니다</h1>
          <p className="mt-3 text-slate-600">새 접수를 진행한 뒤 접수 완료 정보를 확인해 주세요.</p>
  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-12">
      <Card className="p-8 text-center">
        ...
        <p className="mt-3 text-slate-600">{reception.hospitalName} 접수가 완료되었습니다.</p>
