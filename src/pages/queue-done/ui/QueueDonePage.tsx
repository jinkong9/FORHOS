  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-12">
      <Card className="p-8 text-center">
        ...
        <p className="mt-3 text-slate-600">진료 순서가 가까워지면 병원 대기 현황에서 확인할 수 있습니다.</p>
        ...
        <div className="mt-8 grid gap-3 rounded-lg bg-slate-50 p-4 text-left sm:grid-cols-2">
          ...
          <div className="rounded-md bg-white p-4">
            <p className="text-xs font-semibold text-slate-500">예상 대기</p>
            <p className="mt-2 flex items-center gap-2 text-lg font-black text-slate-950">
              <Clock3 className="size-5 text-teal-700" aria-hidden="true" />
              {currentQueue.estimatedMinutes}분
            </p>
          </div>
        </div>

        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          <Link to={routes.queueStatus}>
